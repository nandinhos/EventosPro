...
<head>
    ...
    <style>
        /* CSS para um Relatório Profissional e Minimalista */
        @page { margin: 30px; }
        body { 
        ...
        .summary-table tfoot .total-value { color: #4f46e5; } /* Cor primária */

        /* --- SEPARADOR DE PÁGINA --- */
        .page-break { page-break-after: always; }

        /* --- VISÃO ANALÍTICA (Página 2+) --- */
         /* --- VISÃO ANALÍTICA (Página 2+) --- */

    .analytical-title { font-size: 18px; color: #1f2937; margin-top: 0; border-bottom: 1px solid #d1d5db; padding-bottom: 5px; }

    .booker-group { page-break-inside: avoid; margin-bottom: 25px; }
    ...
    .details-table .subtotal-row .subtotal-value {
...
<body>
    ...
    {{-- PÁGINA 1: VISÃO SINTÉTICA --}}
    <h2 class="analytical-title">Resumo por Booker</h2>
    <table class="summary-table">
        <thead>
            <tr>
                <th>Booker</th>
                <th class="text-right">Cachê Total (BRL)</th>
        ...
        <tbody>
            @foreach($performanceData['tableData'] as $bookerData)
                <tr>
                    ...
                    <td class="text-right">R$ {{ number_format($bookerData['total_cache'], 2, ',', '.') }}</td>
    ...
    {{-- PÁGINA 2 EM DIANTE: VISÃO ANALÍTICA --}}
            ...
            <table class="details-table">
                <thead>
                    <tr>
                        ...
                        <th style="width: 60%;">Artista - Local do Evento</th>
                        <th class="text-right" style="width: 25%;">Valor do Contrato</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="subtotal-row">
                        ...
                        <td class="text-right subtotal-value">R$ {{ number_format($bookerData['total_cache'], 2, ',', '.') }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
