        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
            <div>
                <h2 class="font-semibold text-2xl text-gray-800 dark:text-white leading-tight">
                    Sua Central de Desempenho
                </h2>
                <p class="text-sm text-gray-500 dark:text-gray-400">Acompanhe suas vendas, comissões e atividades.</p>
            </div>
            {{-- Nenhum botão de ação para o booker aqui --}}
        </div>
    </x-slot>
    ...
    <div class="py-0">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md">
                <form method="GET" action="{{ route('booker.portal') }}">
                    <div class="flex flex-wrap items-end gap-4">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <a href="{{ route('booker.portal') }}" class="bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-500 px-4 py-2 rounded-md text-sm font-semibold">Limpar</a>
                        </div>
                    </div>
                </form>
            </div>
                ...
                <div class="border-b border-gray-200 dark:border-gray-700">
                    <nav class="-mb-px flex space-x-6" aria-label="Tabs">
                        <a href="#" @click.prevent="tab = 'analysis'"
                           :class="tab === 'analysis' ? 'border-primary-500 text-primary-600 dark:text-primary-400' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'"
                           class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                           Análise de Vendas
                        </a>
                        <a href="#" @click.prevent="tab = 'highlights'"
                           :class="tab === 'highlights' ? 'border-primary-500 text-primary-600 dark:text-primary-400' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'"
                           class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                           Destaques & Métricas
                        </a>
                    </nav>
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            <div class="bg-blue-100 dark:bg-blue-900/20 p-4 rounded-lg">
                                <h3 class="text-sm text-gray-500 dark:text-gray-400">Total Vendido {{ empty($filters['start_date']) ? '(Total)' : '(no período)' }}</h3>
                            ...
                            <div class="bg-yellow-100 dark:bg-yellow-900/20 p-4 rounded-lg">
                                <h3 class="text-sm text-gray-500 dark:text-gray-400">Gigs Vendidas {{ empty($filters['start_date']) ? '(Total)' : '(no período)' }}</h3>
                            ...
                            <div class="bg-green-100 dark:bg-green-900/20 p-4 rounded-lg">
                                <h3 class="text-sm text-gray-500 dark:text-gray-400">Comissão Recebida</h3>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                            ...
                            @else
                                <div class="text-center py-16 px-6">
                                    ...
                                    <p class="text-sm text-gray-500 mt-1">Aplique um filtro de data para ver a lista detalhada de suas vendas.</p>
                                </div>
                            @endif
                        </div>
                    </div>
