                     ...
                     <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm">
                        <thead class="bg-gray-50 dark:bg-gray-900/50">
                            <tr>
                                ...
                                <th class="px-4 py-2 text-right">Valor Calculado (R$)</th>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            @foreach ($calculations as $methodName => $value)
                                <tr>
                                    ...
                                    <td class="px-4 py-2 text-right font-semibold">{{ number_format($value, 2, ',', '.') }}</td>
                                    <td class="px-4 py-2 text-gray-500 italic text-xs">
                                        @switch($methodName)
                                            ...
                                            @case('calculateArtistInvoiceValueBrl')
                                                Cachê Líquido Artista + Despesas Reembolsáveis.
                                                @break
                                            @default
                                                -
                                        @endswitch
