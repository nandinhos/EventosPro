        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            @if($overduePayments->isNotEmpty())
                <tfoot class="bg-red-50 dark:bg-red-900/20">
                    <tr>
                        <td colspan="3" class="px-6 py-4 text-right text-sm font-semibold text-red-700 dark:text-red-300">
                            Total Vencido:
                        </td>
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead class="bg-green-50 dark:bg-green-900/20">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-semibold text-green-700 dark:text-green-300 uppercase tracking-wider">Artista - Gig - Local</th>
            ...
            @if($futurePayments->isNotEmpty())
                <tfoot class="bg-green-50 dark:bg-green-900/20">
                    <tr>
                        <td colspan="3" class="px-6 py-4 text-right text-sm font-semibold text-green-700 dark:text-green-300">
                            Total Futuro:
                        </td>
